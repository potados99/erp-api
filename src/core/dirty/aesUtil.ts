// https://portal.inu.ac.kr:444/enview/javascript/aesUtil.js
// noinspection ES6ConvertVarToLetConst,SpellCheckingInspection,EqualityComparisonWithCoercionJS,JSUnusedAssignment,PointlessArithmeticExpressionJS,JSSuspiciousNameCombination,JSUnusedLocalSymbols,DuplicatedCode
// @ts-nocheck

export default function AES_Encode(plain_text: string, key: string): string {
